...
namespace PetroFlow_BusinessLayer.Production.NodalAnalysis.Vertical_Lifting_Preformance.VLPGeneralEquations
{
    public static class VLPDimensionlessNumbers
    {
        ...
        public static double DetermineLiquidVelocityNumber(VLPDataInput input)
        {
        ...
        public static double DetermineGasVelocityNumber(VLPDataInput input)
        {
        ...
        public static double DeterminePipeDiameterNumber(VLPDataInput input)
        {
        ...
        public static double DetermineViscosityNumber(VLPDataInput input)
        {
