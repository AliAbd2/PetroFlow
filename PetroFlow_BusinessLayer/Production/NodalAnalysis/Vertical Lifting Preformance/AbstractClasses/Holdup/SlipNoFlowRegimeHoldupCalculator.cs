...
{
    /// <summary>
    /// Marker base class for Holdup correlations
    /// compatible with slip-No-flow-regime models.
    /// </summary>

    public abstract class SlipNoFlowRegimeHoldupCalculator : BaseHoldupCalculator
    {
