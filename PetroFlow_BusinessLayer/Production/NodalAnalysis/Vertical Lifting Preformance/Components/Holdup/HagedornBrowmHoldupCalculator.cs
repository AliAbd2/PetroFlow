...
namespace PetroFlow_BusinessLayer.Production.NodalAnalysis.Vertical_Lifting_Preformance.VLPComponents.VLPHoldup
{
    public class HagedornBrownHoldupCalculator : SlipNoFlowRegimeHoldupCalculator
    {
        ...
        protected override void ValidateRawInput(VLPDataInput input, ref NodalAnalysisValidationResult validationResult)
        {
        ...
        private double _determineLiquidVelocityNumber(VLPDataInput input)
        {
        ...
        private double _determineGasVelocityNumber(VLPDataInput input)
        {
        ...
        private double _determinePipeDiameterNumber(VLPDataInput input)
        {
        ...
        private double _determineViscosityNumber(VLPDataInput input)
        {
        ...
        protected override double ComputeLiquidHoldup(VLPDataInput input,
            ref NodalAnalysisValidationResult validationResult)
        {
