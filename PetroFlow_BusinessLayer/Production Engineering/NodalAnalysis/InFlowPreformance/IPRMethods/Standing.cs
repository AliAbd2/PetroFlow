...
namespace PetroFlow_BusinessLayer.Production.NodalAnalysis.InFlowPreformance.Methods
{
    ...
    internal class Standing : IPRMethodBase, IFuturePredictable
    {
        ...
        public override IPRRequirements InputRequirements => new()
        {
            ...
            | IPRInputFields.TestFlowEfficiency,

            Future = IPRFutureInputFields.FutureReservoirPressure
            | IPRFutureInputFields.PresentOilRelativePermeability
            | IPRFutureInputFields.PresentOilViscosity
            | IPRFutureInputFields.PresentOilFormationVolumeFactor
            | IPRFutureInputFields.FutureOilRelativePermeability
            | IPRFutureInputFields.FutureOilViscosity
            | IPRFutureInputFields.FutureOilFormationVolumeFactor,
