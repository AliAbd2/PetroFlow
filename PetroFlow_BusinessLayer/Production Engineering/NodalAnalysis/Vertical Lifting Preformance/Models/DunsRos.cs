...
namespace PetroFlow_BusinessLayer.Production.NodalAnalysis.Vertical_Lifting_Preformance.Models
{
    public class DunsRos : SlipFlowRegime
    {
        ...
        private readonly IFlowRegimeDetector _regimeDetector;

        private readonly IFrictionFactorCalculator _frictionFactorCalculator;

        private readonly IHoldupCalculator _holdupCalculator;
            ...
            ref NodalAnalysisValidationResult validationResult)
        {
            ...
            return _regimeDetector.Detect(input, ref validationResult);
            ...
            ref NodalAnalysisValidationResult validationResult)
        {
            ...
            return _holdupCalculator.ComputeLiquidHoldup(input, 
            ...
            ref NodalAnalysisValidationResult validationResult)
        {
            ...
            return _frictionFactorCalculator.ComputeFrictionFactor(input,
